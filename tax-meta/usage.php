<?php
    ...
    Description: Add Tax Meta
    Plugin URI: https://github.com/adrianaguirre/wp-plugins
    Version: 1.0.0
    Author: Aguirre, Adrian
    Author URI: https://github.com/adrianaguirre/
    ...
    */
    ...
    if (is_admin()) {
        ...
        //text field
        $my_meta->addText($prefix . 'text_field_id', array(
            'name' => __('My Text ', 'tax-meta'),
            'desc' => 'this is a field desription'
        ));
        //textarea field
        ...
        $my_meta->addRadio($prefix . 'radio_field_id', array(
            ...
            'name' => __('My Radio Filed', 'tax-meta'),
